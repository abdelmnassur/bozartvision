                ...
                <div class="row">
                                ...
                                <div class="img-large-slider common-slider" data-slick='{
                                    ...
                                    <div class="img-large-wrapper">
                                        <a href="assets/img/products/bags/39.jpg" data-fancybox="gallery">
                                            {{-- <img src="{{ asset('storage/image/oeuvres/'.$artsite->user->) }}" alt="img"> --}}
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-details ps-lg-4">
                            <h3 class="product-title mb-3">{{ $artiste->user->prenom }}</h3>
                            ...
                            <form class="product-form" action="#">
                                <div class="buy-it-now-btn mt-2">
                                    <button type="submit" class="position-relative btn-atc btn-buyit-now">ACHETER MAINTENANT</button>
                                </div>
                            </form>
            ...
            <div class="container">
                <div class="tab-list product-tab-list">
                    <nav class="nav product-tab-nav">
                        <a class="product-tab-link tab-link active" href="#pdescription" data-bs-toggle="tab">Commentaire</a>
                    </nav>
                </div>
                    ...
                    <div id="pdescription" class="tab-pane fade show active">
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-12 col-12">
                                <div class="desc-img">
                                    <img src="{{ asset('template1/img/product.jpg') }}" alt="img">
                                </div>
                            </div>
