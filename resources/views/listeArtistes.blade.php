                ...
                <div class="row">
                            ...
                            <div class="product-img-large">
                                <div class="img-large-slider common-slider" data-slick='{
                                    ...
                                    <div class="img-large-wrapper">
                                        <img src="{{ asset('storage/image/photo_profil/'.$artistes[0]->user->photo) }}" alt="img">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-details ps-lg-4">
                            <h3 class="product-title mb-3">{{ $artistes[0]->user->prenom }} {{ $artistes[0]->user->nom }}</h3>
                            
                            <h4 class="product-vendor product-meta mb-3"> <strong class="label">Nationalité :</strong> Burkinabé </h4>
                            
                            <h4 class="product-vendor product-meta mb-3"> <strong class="label">Date de naissance : </strong>{{ $artistes[0]->user->date_de_naissanse }}
                            ...
                            <div class="footer-social-wrapper">
                                <ul
                                    ...
                                    <li class="footer-social-item">
                                        <a href="{{ $artistes[0]->page_twitter }}">
                                    ...
                                    <li class="footer-social-item">
                                        <a href="{{ $artistes[0]->page_facebook }}">
                                    ...
                                    <li class="footer-social-item">
                                        <a href="{{ $artistes[0]->page_instagram }}">
            ...
            <div class="container">
                <div class="tab-list product-tab-list">
                    <nav class="nav product-tab-nav">
                        <a class="product-tab-link tab-link active" href="#pdescription" data-bs-toggle="tab">BIOGRAPHIE</a>
                    </nav>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-12 col-12">
                                <div class="desc-content">
                                    <h4 class="heading_18 mb-3"> {{ $artistes[0]->biographie }} </h4>
                                </div>
                            </div>
                        </div>
                    </div>
