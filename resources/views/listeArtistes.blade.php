               ...
               <div class="row">
                           ...
                           <div class="product-img-large">
                               <div class="img-large-slider common-slider" data-slick='{
                                   ...
                                   <div class="img-large-wrapper">
                                       <img src="{{ asset('storage/image/photo_profil/'.$artiste->user->photo) }}" alt="img">
                                   </div>
                               </div>
                           </div>
                   ...
                   <div class="col-lg-6 col-md-12 col-12">
                       <div class="product-details ps-lg-4">
                           <h3 class="product-title mb-3">{{ $artiste->user->prenom }} {{ $artiste->user->nom }}</h3>
                           
                           <h4 class="product-vendor product-meta mb-3"> <strong class="label">Nationalité :</strong> Burkinabé </h4>
                           ...
                           <h4 class="product-vendor product-meta mb-3"> Date de naissance: {{ $artiste->user->date_de_naissance }}
                       ...
                       <div class="row">
                           <div class="col-lg-7 col-md-12 col-12">
                               <div class="desc-content">
                                   <h4 class="heading_18 mb-3"> C'est quoi ?</h4>
